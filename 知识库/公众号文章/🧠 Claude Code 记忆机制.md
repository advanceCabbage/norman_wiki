...
> 官方措辞很克制：两条规则矛盾时 _"Claude may pick one arbitrarily"_。所以正确做法是**主动消除冲突**，而不是指望靠层级覆盖兜底。
...
例如：/Users/haoyang/.claude/projects/-Users-haoyang-Documents----norman-wiki/memory
...
└── api-conventions.md # 详细主题笔记，按需读取
```
...
- [微信公众号发文工作流](wechat-publish-workflow.md) — wechat-official-draft skill 的账号类型/预览限制/凭证/微信号等关键背景
- [公众号内容润色文风偏好](wechat-content-polish-style.md) — 简化要大刀阔斧去冗余、标题要务实不浮夸
```
